...
<div class="card">
  <div class="card-header bg-dark text-white">
    <div class="row">
      <div class="col-sm-6">
        <h4 class="card-title"><b>Invoice Line - Edit</b></h4>
      </div>
      <div class="col-sm-6">
  ...
  <form id="submitForm" method="POST" data-url="{{ route('invoice_lines.update', $record->id) }}">
    @csrf
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <a href="{{ route('invoice_lines.index') }}" class="btn btn-secondary">↩️ Back</a>
    </div>
  </form>
</div>
<script>
